...
import granularTests from "./data/granularTests.json";
        ...
        return (
          <>
            <div className="start-quiz-container">
              ...
              <button
                title={isOpen ? "Скрий темите" : "Покажи темите"}
              ...
              >
                ...
                <svg
                  ...
                  className="arrow-expand-collapse-icon"
              ...
              {isOpen && (
                <div className="small-buttons-container">
                  {granularTests.map((test) => (
                    <button
                      key={test.title}
                      title={`Тест по тема: ${test.title} ( ${SINGLE_THEME_QUIZ_LENGTH} въпроса )`}
                      className="button-start-test-small"
                      onClick={() =>
                        startQuiz(
                          test.questionsNumbers.map(
                            (num) => allQuestions.find((q) => q.question_number === num.toString()) || allQuestions[0]
                          )
                        )
                      }
